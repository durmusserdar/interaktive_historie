  ...
  juYr: function (t, e, n) {
    ...
    !(function (e, n) {
      ...
      function L(t, e, n, i) {
        ...
        if (
          g ||
          (p > 1 && "string" == typeof h && !vt.checkClone && re.test(h))
        )
        ...
        if (
          ...
          for (a = yt.map(T(o, "script"), A), l = a.length; f < p; f++)
            (u = o),
              f !== d &&
          ...
          if (l)
            for (
              c = a[a.length - 1].ownerDocument, yt.map(a, j), f = 0;
              f < l;
              f++
            )
              (u = a[f]),
      ...
      function Q(t, e, n) {
        ...
        for (G(c, u.opts.specialEasing); r < s; r++)
          if ((i = Q.prefilters[r].call(u, t, c, u.opts)))
            return (
          ...
          var o = n.length > 0,
            ...
            s = function (i, s, a, l, u) {
              ...
              for (
                ...
                if (r && c) {
                  for (
                    f = 0, s || c.ownerDocument === j || (A(c), (a = !I));
                    (p = t[f++]);
              ...
              o = {
                ...
                then: function (t, i, o) {
                  ...
                  return yt
                    .Deferred(function (n) {
                      e[0][3].add(
                        r(0, n, yt.isFunction(o) ? o : p, n.notifyWith)
                      ),
                        e[1][3].add(r(0, n, yt.isFunction(t) ? t : p)),
        ...
        yt.extend({
          ...
          ready: function (t) {
            (!0 === t ? --yt.readyWait : yt.isReady) ||
              ((yt.isReady = !0),
              (!0 !== t && --yt.readyWait > 0) || Rt.resolveWith(st, [yt]));
          },
        }),
        ...
        trigger: function (t, e, i, o) {
          ...
          if (
            ...
            if (!o && !f.noBubble && !yt.isWindow(i)) {
              for (
                l = f.delegateType || d, Se.test(l + d) || (s = s.parentNode);
                s;
                s = s.parentNode
              )
                p.push(s), (a = s);
          ...
          ajax: function (t, e) {
            function i(t, e, i, a) {
              ...
              c ||
                ...
                u
                  ? (h.ifModified &&
                    ...
                    204 === t || "HEAD" === h.type
                      ...
                      : 304 === t
                      ? (T = "notmodified")
                      : ((T = x.state), (p = x.data), (d = x.error), (u = !d)))
                ...
                (b = void 0),
                f &&
                  m.trigger(u ? "ajaxSuccess" : "ajaxError", [C, h, u ? p : d]),
                y.fireWith(g, [C, T]),
                f &&
            ...
            if (
              ...
              try {
                (u.href = h.url),
                  (u.href = u.href),
                  (h.crossDomain =
                    _e.protocol + "//" + _e.host != u.protocol + "//" + u.host);
              } catch (t) {
                h.crossDomain = !0;
              }
            }
